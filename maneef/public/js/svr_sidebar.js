frappe.ui.form.on("Site Visit Report", {
    refresh: function(frm) {
        ...
        Promise.all([
            ...
            let photos = r1.message || 0;
            let openIssues = r2.message || 0;

            let html = '<div style="padding:12px 0;">';
            html += maneef.sidebar.sidebarItem("Photos Attached", photos, photos > 0 ? "#10b981" : "#f59e0b");
            html += maneef.sidebar.sidebarItem("Open Issues", openIssues, openIssues > 0 ? "#ef4444" : "#10b981");
            html += '</div>';
