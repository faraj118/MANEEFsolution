frappe.ui.form.on("Customer", {
    refresh: function(frm) {
        ...
        Promise.all([
            ...
            let activeProjects = r1.message || 0;
            let openCharters = r2.message || 0;

            let html = '<div style="padding:12px 0;">';
            html += maneef.sidebar.sidebarItem("Active Projects", activeProjects, activeProjects > 0 ? "#10b981" : "#64748b");
            html += maneef.sidebar.sidebarItem("Open Charters", openCharters, openCharters > 0 ? "#f59e0b" : "#64748b");
            html += '</div>';
